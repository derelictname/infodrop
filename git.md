...
Здесь представлен пример. Один tree самый верхний, который содержит чексуммы и имена других blob и tree, которые в свою очередь содержат чексуммы своих blob и tree. Если какой то файл изменится, то изменится его чексумма, а значит будет создан новый blob, а значит и tree с его чексуммой и других tree, содержащих чексумму этого tree. Таким образом Git хранит неизменную версию каких-нибудь файлов и папок.
