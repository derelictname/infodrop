...
Объекты хранятся в папке `.git/objects`. Содержимое текстового файла появилось в виде blob в файле `.git/objects/f0/2e02a059f190d3e68d42f8438fa3f094eda1b5`. Имя папки вместе с именем файла это чексумма SHA1 содержимого blob. Это образует контентно-адресуемое хранилище, в котором расположение файлов связано с их содержимым.
